...
def button_click(update:Update,context:CallbackContext):
    ...
    if filepath is not None:
        query.edit_message_text("Yazıları okumaya çalışıyorum, azıcık bekleteceğim...")
        ...
        if data['IsErroredOnProcessing']==False:
            ...
            query.edit_message_text(text="⚠️Ahh, kesin yanlış birşey oldu, lütfen sonra tekrar dene.⚠️")
    else:
        query.edit_message_text("⚠ Ahh, kesin yanlış birşey oldu, lütfen sonra tekrar dene.⚠️")
