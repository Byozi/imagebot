...
def extract_image(update:Update,context:CallbackContext):
    ...
    keyboard = [[InlineKeyboardButton("English ", callback_data='eng'), InlineKeyboardButton("Russian", callback_data='rus'),InlineKeyboardButton("Czech", callback_data='cze')],
                ...
                [InlineKeyboardButton("Arabic", callback_data='ara'),InlineKeyboardButton("Afrikans", callback_data='AFR'),InlineKeyboardButton("Turkish", callback_data='tur'), InlineKeyboardButton("German", callback_data='gre')],
    ...
    m = update.message.reply_text('Lütfen bir dil seç : ', reply_markup=reply_markup,quote=True)
